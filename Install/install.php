...
{
    /*
    var $dbHost = 'id67.free.yunhosting.net';
    var $dbUser = 'meiren1520';
    var $dbPassword = 'PPowuwHtKJ';
    var $dbSchema = 'meiren1520';
    */
...
//测试
$dbM = new DBManager('id67.free.yunhosting.net','meiren1520','PPowuwHtKJ','meiren1520');
if($dbM->createFromFile('ncms.sql',null,''))
{
	echo 'yes';
}
else 
